...
public class Model {
    ...
    private int[] stukkenTeller;
    private boolean[][] bord;

    public Model(){
        stukkenTeller = new int[7];
        for(int i = 0; i < 7; i++){
            stukkenTeller[i] = 5;
        }
        bord = new boolean[6][7];
    }
    ...
    public void playMove(int column) {
        ...
        bord[stukkenTeller[column]][column] = true;
        printBord();
        stukkenTeller[column]--;
